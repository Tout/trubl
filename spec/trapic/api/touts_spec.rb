...
describe Trapic::API::Touts do
  ...
  it '.featured_touts returns a collection of Touts' do
    ...
    touts = Trapic::Client.new.featured_touts()
  ...
  it '.tout_liked_by returns a Collection of Users liking the specified tout' do
    ...
    users = Trapic::Client.new.tout_liked_by("fhcl57")
  ...
  it '.retrieve_tout returns a Tout object' do
    ...
    tout = Trapic::Client.new.retrieve_tout("fhcl57")
    expect(tout).to be_a Trapic::Tout
  ...
  it '.retrieve_tout_conversation returns the Conversation related to a Tout' do
    ...
    conversation = Trapic::Client.new.retrieve_tout_conversation('fhcl57')
  ...
  it '.retrieve_latest returns the latest Touts' do
    ...
    touts = Trapic::Client.new.latest_touts()
    expect(touts).to be_a Trapic::Touts
    expect(touts.pagination).to be_a Trapic::Pagination
    touts.each do |u|
      expect(u).to be_a Trapic::Tout

...
describe ReTout::API::Hashtags do
  ...
  it 'retrieve_hashtag_touts returns Touts::Collection matching a hashtag' do
    ...
    collection = ReTout::Client.new.retrieve_hashtag_touts("ows")
  ...
  it 'retrieve_trending_hashtags returns json describing hashtags' do
    ...
    collection = ReTout::Client.new.retrieve_trending_hashtags()
    expect(collection).to be_a ReTout::Utils::Collection
    expect(collection.pagination).to be_a ReTout::Utils::Pagination
  ...
  it 'retrieve_suggested_hashtags returns json describing hashtags' do
    ...
    collection = ReTout::Client.new.retrieve_suggested_hashtags("arc", 5)
    expect(collection).to be_a ReTout::Utils::Collection
